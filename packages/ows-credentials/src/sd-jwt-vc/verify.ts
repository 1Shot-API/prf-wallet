...
import { sdJwtHasher } from "./crypto.js";
import {
  createEd25519VerifierFromJwk,
  type IssueSdJwtVcInput,
} from "./issuer.js";
import { DEMO_ISSUER_PUBLIC_JWK } from "./demo-keys.js";
...
export async function verifySdJwtVcPresentation(
  ...
  const issuerJwk = input.issuerPublicKeyJwk ?? DEMO_ISSUER_PUBLIC_JWK;
  const issuerVerifier = createEd25519VerifierFromJwk(issuerJwk);
